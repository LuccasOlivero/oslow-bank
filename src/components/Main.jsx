    ...
    <>
      <main className="relative w-full h-screen bg-[#f2f2f2] ">
        ...
        <div className="w-full flex flex-col h-full justify-center items-center ">
          <div className="relative max-w-[1600px] flex flex-col justify-evenly h-full w-full">
            <div className="flex items-center flex-col">
              ...
              <div className="relative w-[12rem] h-[3.5rem] bg-gray-900 rounded-full flex items-center font-bold text-white hover:bg-gray-950 transition-all ease-in duration-300 p-2 justify-center text-lg mb-[14rem]">
                Join Now
      ...
      <section className="flex justify-center relative h-full w-full bg-[#f2f2f2]">
        <div className="flex justify-center items-center gap-8 max-w-[1600px] my-[3rem] w-full">
          <div className="bg-violet-700 w-[40rem] h-[25rem] relative"></div>
          <div className="bg-green-900 w-[40rem] h-[25rem] relative"></div>
        </div>
      </section>
    </>
  );
