...
function Card({ title, icon }) {
  return (
    <Link
      to="/login"
      className="w-[9rem] h-[12rem] bg-white rounded-3xl flex flex-col justify-between items-center p-5 shadow-lg hover:shadow-2xl transition-all ease-in duration-300 "
    >
